...
::: {layout="[ [1,1] ]"}
```{r}
df_bike_ped <- read.csv("data/NF_Bike_Ped_fatalcrashes_19_23.csv")
...
```{r, message=FALSE}
# Load your GeoJSON file
geojson_data_unfiltered <- st_read("data/Sidewalks_and_Gaps_NF24.geojson", quiet = TRUE)
...
df_bridge <- read.csv("data/NationalBridgeCond2024.csv")
