...
labs <- paste("<b>Deck Condition:</b> ", df_bridge$DECK_COND_058, "<br><b>Bridge Condition:</b>", df_bridge$DECK_COND_058, "<br><b>Feature:  </b>",df_bridge$FEATURES_DESC_006A,"<br><b>Facility: </b>",df_bridge$FACILITY_CARRIED_007,"<br><b>Location: </b>",df_bridge$LOCATION_0) 
...
leaflet(data = df_bridge) %>%
  ...
  addCircleMarkers(~LONGDD, ~LATDD, # Use the Longitude and Latitude columns
                   popup = ~paste0("<b>Deck Condition: </b>", DECK_COND_058, "<br><b>Bridge Condition: </b>",DECK_COND_058, "<br><b>Feature:  </b>",FEATURES_DESC_006A,"<br><b>Facility: </b>",FACILITY_CARRIED_007,"<br><b>Location: </b>",LOCATION_009), 
                   radius=5,label = lapply(labs, htmltools::HTML), color = ~pal(DECK_COND_058), weight = 1, 
                   fillOpacity = 0.8) %>%
  setView(lng = -81.655651, lat = 30.232184, zoom = 9) %>% 
  addEasyButton(
    easyButton(
