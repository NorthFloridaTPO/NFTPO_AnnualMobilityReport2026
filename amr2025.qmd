...
There is no benchmark for population growth. Increases impact the demand for mobility. The graph below shows the population of the four North Florida counties by year.
...
There is no benchmark for licensed drivers. Increases impact the demand for mobility. The graph below shows the number of licensed drivers in the four North Florida counties by year.
...
hchart(df_drivers, "column", hcaes(x = year, y = drivers, group = county)) %>%
  ...
  hc_subtitle(text = 'Source: <a href="https://www.flhsmv.gov/pdf/driver-vehiclereports/2024annuallicenseddriverreport.pdf" target="_blank"><b>Florida Highway Safety and Motor Vehicles</b></a>') %>%
  hc_xAxis(title = list(text = "Year")) %>%
  hc_tooltip(shared = TRUE, pointFormat = "<span style='color:{series.color}'>{series.name}</span>: <b>{point.y}</b><br/>") %>%
  hc_legend(enabled = TRUE) %>%
  hc_add_theme(hc_theme_smpl()) %>%
...
Transportation barriers are the third leading cause of missing a medical appointment for older adults across the country. Medically Underserved Areas/Populations are designated by the U.S. Department of Health Resources and Services Administration as having too few primary care providers, high infant mortality, high poverty rate or a high elderly population. Nearly 370,000 persons in North Florida live in medically underserved areas. There are no benchmarks for population in underserved areas. It is desirable to ensure the population is adequately served.
...
Increases are preferred and annual monitoring is conducted. The graph below shows the total GDP of the four counties in North Florida by year.
...
The target is to have zero injuries or fatalities resulting from crashes. The graph below shows the total crashes in the four North Florida counties by year.
...
The number of fatalities is a crucial benchmark of progress when assessing the Target Zero initiative. According to the FLHSMV dashboard, there were 222 fatalities within the region during 2024. The graph below shows the total fatalities in the four North Florida counties by year.
...
The FLHSMV dashboard lists the total number of injuries as 19,768 within the region during 2024. The chart below shows the total injury crashes in the four North Florida counties by year.
...
The rate of crashes is the ratio of the total number of crashes to the number of vehicle miles traveled (VMT) expressed in 100 million VMT. In 2023, the rate of fatalities was 1.41, the rate of injuries was 105.5, and the rate of all crashes was 165.2. All rates have significantly decreased since 2021.
...
According to the FLHSMV dashboard, the number of non-motorized fatalities for the region was 65 in 2024. A total of 53 fatalities were attributed to pedestrians and 12 were to cyclists.
...
The Jacksonville Transportation Authority (JTA) tracks transit ridership metrics. Ridership levels have remained consistent over the last five years. The JTA operates and maintains the St. Johns River Ferry, ReadiRide (on-call transportation service), Clay Flex, St. Johns Express, Clay Express, and Nassau Express. The 2023 ridership data related to these services are shown in table below. On-time performance was only tracked for the St. Johns River Ferry during 2022 and this came in at 98%.
...
JAXPORT's terminals shipped less tons of cargo in fiscal year 2024 than 2023. The Port of Fernandina shipping is slightly more in 2024. Overall shipping tonnage has remained steady over the last five years.
...
Based on the FDOT Sourcebook, the peak hour for the North Florida TPO region experiences heavy congestion on 5.5 % of the roadway system in 2023. The numbers have been continuing to climb since 2020. The last five years of data (from 2019 – 2023) are 4.6 %, 1.8 %, 2.9 %, 4.2 %, and 5.5 %. The table below summarizes the percentage of heavy congestion for the North Florida region by year.
...
Only 30% of the congestion in our region in 2019 was caused by recurring delays (Source: RITIS (Regional Integrated Transportation Information System) Causes of Congestion Report based on data from 2019). Other sources of delays include holiday peaks, incidents, weather, excess delay at signals, weather, and work zones. Transportation Systems Management and Operations (TSM&O) strategies are need to reduce delays caused by non-recurrent factors.
...
This section deals with preserving and maintaining bridge and pavement conditions in the region. Pavement condition is summarized for Interstate and non-Interstate facilities that are on the National Highway System (NHS). The % is based on the lane-miles of facilities. Bridges are summarized by NHS and non-NHS facilities. The percentage is calculated based on the bridge deck area. Goals are set by FDOT for how much of each category is in good condition and how much is in poor condition.
